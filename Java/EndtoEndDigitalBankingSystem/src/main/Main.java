...
public class Main {
    ...
    private static void viewAccounts() {
        ...
        for (Account acc : accounts) {
            System.out.println("Acc No: " + acc.getAccountNumber() + " | Type: " + acc.getClass().getSimpleName() + " | Balance: $" + acc.getBalance());
        }
    }
    ...
    private static void viewHistory(Scanner scanner) {
        String accNo = InputUtil.readString(scanner, "Enter Account Number: ");
        List<Transaction> history = transactionService.getTransactionHistory(accNo);
        if (history.isEmpty()) {
